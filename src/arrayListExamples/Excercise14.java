...
public class Excercise14 {
	...
	public static <ParniNeparni> void main(String[] args) {
		...
		res = evenOddNumbers(broevi);
		System.out.println("Even: " +res.getEven() +" Odd:" + res.getOdd());
	...
	public static EvenOdd evenOddNumbers(ArrayList<Integer>list) {
